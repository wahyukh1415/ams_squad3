            ...
            <div class="col-12 col-md-6 ps-md-5 d-flex align-items-center">
                <div>
                    <p class="paragraph text-secondary">
                        Discover new auctions, place your bids, and uncover
                        unique treasures. Dive in now to explore exciting
                        opportunities and win big rewards!
                    </p>
                    <a class="btn btn-primary" href="#active-auction"
                        >Explore now</a
                    >
                </div>
            </div>
