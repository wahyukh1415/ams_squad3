...
async function updateProfile() {
    ...
    const response = await axios.put('http://127.0.0.1:8080/secured/user/update-profile', newData, {
        headers: {
...
<template>
    <section class="settings d-flex flex-column gap-5 container mt-5">
        ...
        <div class="detail-profile">
            <div class="profile-head mb-2 row justify-content-between align-items-center">
                    ...
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h1 class="modal-title fw-semibold fs-3 mb-3 text-center" id="exampleModalLabel">Update Profile</h1>

                                <form action="" id="form-modal">
                                    <div class="form-group position-relative">
                                        <label for="username">NAME</label>
                                        <input class="w-100" type="text" id="username" autocomplete="username" name="username" v-model="nameProfile" />
                                    </div>

                                    <div class="form-group position-relative">
                                        <label for="email">EMAIL</label>
                                        <input class="w-100" autocomplete="email" type="email" id="email" v-model="emailProfile" />
                                    </div>
                                </form>
                            ...
                            <div class="footerModal d-flex gap-3 px-3 pb-3 justify-content-between">
                                <button type="button" class="btn fw-semibold py-3 w-100 border border-1 border-dark" data-bs-dismiss="modal">CANCEL</button>
                                <button @click="updateProfile" type="submit" class="btn fw-semibold btn-primary w-100">SAVE</button>
                            </div>
                        </div>
                    </div>
                </div>
