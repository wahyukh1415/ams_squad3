...
<template>
    <nav
        class="navbar navbar-expand-lg bg-body-tertiary sticky-top w-100 z-3 shadow"
    >
        <div class="container">
            <!-- offcanvas toogler 1 -->
            <button
            ...
            >
                ...
                >
                    <ul
                        class="nav d-flex flex-column flex-lg-row gap-lg-0 gap-2"
                    >
                        <li class="nav-item">
                            <RouterLink
            ...
            >
                ...
                <div class="btn-group">
                    ...
                    <ul
                        class="dropdown-menu dropdown-menu-end py-3 profile-drp"
                    >
                        <RouterLink
                            to="/user-profile"
                        ...
                        >
                            ...
                            <p class="fw-semibold fs-6 p-0 m-0">
                                Register Buyer
                            </p>
                        </RouterLink>
                        <RouterLink
